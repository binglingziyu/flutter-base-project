...
class LogConsole extends StatefulWidget {
  ...
  LogConsole({this.dark = true, this.showCloseButton = true})
  ...
  static void init({int bufferSize = 20}) {
    ...
    _initialized = true;
    CustomLogOutput.addOutputListener((e) {
...
class _LogConsoleState extends State<LogConsole> {
  CustomOutputCallback _callback;
  ...
  void initState() {
    ...
    CustomLogOutput.addOutputListener(_callback);
  ...
  @override
  void dispose() {
    CustomLogOutput.removeOutputListener(_callback);
    super.dispose();
  }
}
